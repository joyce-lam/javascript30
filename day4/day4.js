    ...
    const fifteenthHundreds = inventors.filter(inventor => {
      inventor.year >= 1500 && inventor.year < 1600;
    })

    console.log(fifteenthHundreds);
    console.table(fifteenthHundreds);
    ...
    // const links = Array.from(category.querySelectorAll("a")); //create a list
    // const links = [... category.querySelectorAll("a")];
    // const category = document.querySelector(".mw-category");
    // const links = Array.from(category.querySelectorAll("a"))
    // const individualLink = links.map(link => 
    //   link.textContent
    ...
    const sortedPeople = people.sort((lastOne, nextOne) => {
        ...
        const [lastName1, firstName1] = lastOne.split(", ");
        console.log(lastName1, firstName1);

        const [lastName2, firstName2] = nextOne.split(", ");
    ...
    const commuteWays = data.reduce((obj, item) => {
      console.log(item);
      if (!obj[item]) {
        obj[item] = 0;
      }
